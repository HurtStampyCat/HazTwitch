...
const HTML = {
	BTN_INNER: '<div id="accManagerBtn" class="button bigShadowT" onmouseenter="playTick()" style="display:block;width:300px;text-align:center;padding:15px;font-size:23px;pointer-events:all;padding-bottom:22px;margin-left:-5px;margin-top:5px">Alt-Manager</div>',
...
class AccountManager {
	...
	#login = (name, pass) => {
		...
		setTimeout(loginAcc, 100);
		document.getElementById('sex-windowHolder').style.display = "none";
